                    ...
                    <div className="infos">
                        <div>
                            ...
                            <div className="sub link">
                                {location.origin + Routing.generate('app_article', {'slug': elem.slug})}
                                <a href={Routing.generate('app_article', {'slug': elem.slug})} target="_blank"> <span className="icon-link-2" /> </a>
                            </div>
                        </div>
